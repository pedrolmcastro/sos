...
option(SOS_WARNINGS_AS_ERROS "Treat warnings as errors" ON)
...
if(MSVC)
    if("${CMAKE_CXX_FLAGS}" MATCHES "/W3")
        message(STATUS "Removing /W3 flag added by default by CMake: CMP0092")
        string(REGEX REPLACE "/W3" "" CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
    endif()

    list(APPEND SOS_WARNINGS /W4 /permissive-)

    if(SOS_WARNINGS_AS_ERROS)
        list(APPEND SOS_WARNINGS /WX)
    endif()

    if(MSVC_VERSION VERSION_GREATER_EQUAL 1700) # 2012 - 11.
        list(APPEND SOS_WARNINGS
...
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU") # GCC
    list(APPEND SOS_WARNINGS -Wall -Wextra -pedantic)

    if(SOS_WARNINGS_AS_ERROS)
        list(APPEND SOS_WARNINGS -Werror)
    endif()
    ...
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 4.6)
        list(APPEND SOS_WARNINGS -Wdouble-promotion) # Implicit floating-point promotion
    endif()

    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
        list(APPEND SOS_WARNINGS -Wuseless-cast) # Useless cast
    endif()
...
elseif(CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    list(APPEND SOS_WARNINGS -Wall -Wextra -pedantic -Wno-unknown-warning-option)
...
function(sos_target_enable_warnings TARGET)
    target_compile_options(${TARGET} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${SOS_WARNINGS}>)
endfunction()
