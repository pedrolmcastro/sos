...
static void test_is_nullptr() {
    ...
    static_assert(    sos::is_nullptr(comparable_with<std::nullptr_t>{true}));
    static_assert(not sos::is_nullptr(comparable_with<std::nullptr_t>{false}));
    static_assert(    sos::is_nullptr(nothrow_comparable_with<std::nullptr_t>{true}));
    static_assert(not sos::is_nullptr(nothrow_comparable_with<std::nullptr_t>{false}));
}
...
static constexpr void test_is_nullopt() noexcept {
    ...
    static_assert(    sos::is_nullopt(comparable_with<std::nullopt_t>{true}));
    static_assert(not sos::is_nullopt(comparable_with<std::nullopt_t>{false}));
    static_assert(    sos::is_nullopt(nothrow_comparable_with<std::nullopt_t>{true}));
    static_assert(not sos::is_nullopt(nothrow_comparable_with<std::nullopt_t>{false}));
}
