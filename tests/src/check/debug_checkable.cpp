...
static constexpr void test_noop_checkable() noexcept {
    ...
    static_assert(not sos::noop_checkable<sos::asserts_t, empty_struct>);
    static_assert(not sos::noop_checkable<sos::asserts_t, explicit_testable>);
    static_assert(not sos::noop_checkable<sos::asserts_t, nothrow_implicit_testable>);
